    ...
    <el-collapse>
      ...
      <el-collapse-item :title="$t('settings_page.img_name.title')" name="1">
        <ul class="setting-list" style="margin-top: 10rem">
          ...
          <li class="setting-item has-desc">
            <el-switch
              v-model="userSettings.imageName.enableRandom"
              @change="persistUserSettings"
              :active-text="$t('settings_page.img_name.random_switch_name')"
            ></el-switch>
            <span class="desc">{{ $t('settings_page.img_name.random_switch_desc') }}</span>
          </li>
          <li class="setting-item has-desc">
            <el-switch
